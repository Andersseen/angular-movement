    ...
    <article class="max-w-3xl">
      ...
      >
        ...
        <div class="my-6 bg-code-bg rounded-xl border border-border p-4 overflow-x-auto not-prose">
          ...
          ><code class="text-text">&lt;<span class="code-keyword">div</span> <span class="code-attr">moveEnter</span>=<span class="code-string">"fade-up"</span>&gt;This fades up on enter&lt;/<span class="code-keyword">div</span>&gt;</code></pre>
        </div>
